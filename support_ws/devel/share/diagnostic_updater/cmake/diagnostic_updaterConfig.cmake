...
if("TRUE" STREQUAL "TRUE")
  set(diagnostic_updater_SOURCE_PREFIX /home/debian/controls_on_beagle_bone/support_ws/src/diagnostic_updater)
  set(diagnostic_updater_DEVEL_PREFIX /home/debian/controls_on_beagle_bone/support_ws/devel)
  ...
  set(diagnostic_updater_INSTALL_PREFIX /home/debian/controls_on_beagle_bone/support_ws/install)
...
if(NOT "/home/debian/controls_on_beagle_bone/support_ws/src/diagnostic_updater/include" STREQUAL "")
  set(diagnostic_updater_INCLUDE_DIRS "")
  set(_include_dirs "/home/debian/controls_on_beagle_bone/support_ws/src/diagnostic_updater/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir}" STREQUAL "include")
      ...
      message(FATAL_ERROR "Project 'diagnostic_updater' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/debian/controls_on_beagle_bone/support_ws/src/diagnostic_updater/${idir}'.  Ask the maintainer 'Austin Hendrix <namniart@gmail.com>, Brice Rebsamen <brice.rebsamen@gmail.com>' to fix it.")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/debian/controls_on_beagle_bone/support_ws/devel/lib;/opt/ros/indigo/lib;/home/debian/ros_catkin_ws/install_isolated/lib)
